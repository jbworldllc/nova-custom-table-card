...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col h-auto" }, [
    ...
    _c(
      ...
      [
        _vm.header && _vm.header.length > 0
          ? _c("thead", [
              _c(
                "tr",
                [
                  _vm._l(_vm.header, function(head, index) {
                    return _c(
                      "th",
                      { key: index, class: head.class, attrs: { id: head.id } },
                      [
                        _c("span", {
                  ...
                  _vm._v(" "),
                  _vm.hasViewColumn ? _c("th") : _vm._e()
                ],
                2
              )
            ])
        ...
        _vm._v(" "),
        _vm.footer && _vm.footer.length > 0
          ? _c("tfoot", [
              _c(
                "tr",
                [
                  _vm._l(_vm.footer, function(foot, index) {
                    return _c(
                      "th",
                      {
                        key: index,
                        class: _vm.head.class,
                        attrs: { id: foot.id }
                      },
                      [
                        _c(
    ...
    _vm._v(" "),
    _vm.viewall
      ? _c("div", { staticClass: "bg-20 rounded-b-lg flex justify-between" }, [
          _c("div"),
          _vm._v(" "),
          _c("div", [
            _vm.viewall
              ? _c(
                  "a",
                  {
                    ...
                    attrs: { href: _vm.viewall.link }
                  },
                  [_vm._v(_vm._s(_vm.viewall.label))]
                )
              : _vm._e()
          ])
        ])
